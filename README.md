...
| 文档 | 说明 |
|------|------|
| [功能介绍](./docs/功能介绍.md) | 完整功能说明 |
| [架构设计](./docs/架构设计.md) | 系统架构与模块设计 |
| [API 设计](./docs/API设计.md) | HTTP + WebSocket 接口定义 |
| [数据模型](./docs/数据模型.md) | 前后端数据结构 |
| [安全设计](./docs/安全设计.md) | 凭证管理与安全边界 |
| [运行维护](./docs/运行维护.md) | 部署与运维指南 |
| [本地应用与插件安装](./docs/本地应用与插件安装.md) | 安装步骤 |
